...
comment [line] <number>:
    ...
    code.toggle_comment()
comment <number> (until | to) <number>:
...
clear [line] <number>:
    ...
    user.select_range(number, number)
    edit.delete()
clear <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.delete()
copy [line] <number>:
    user.select_range(number, number)
    edit.copy()
copy <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.copy()
cut [line] <number>:
    user.select_range(number, number)
    edit.cut()
cut [line] <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.cut()
(paste | replace) <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.paste()
(select | cell | sell) [line] <number>: user.select_range(number, number)
(select | cell | sell) <number> (until | to) <number>:
    user.select_range(number_1, number_2)
tab that: edit.indent_more()
tab [line] <number>:
    edit.jump_line(number)
    edit.indent_more()
tab <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.indent_more()
...
drag up [line] <number>:
    user.select_range(number, number)
    edit.line_swap_up()
drag up <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.line_swap_up()
drag down [line] <number>:
    user.select_range(number, number)
    edit.line_swap_down()
drag down <number> (until | to) <number>:
    user.select_range(number_1, number_2)
    edit.line_swap_down()
